...
namespace CascadedEditorsSample
{
	public class DataMigrations : IDataMigrations
	{
		...
		private void RunMigrations(string databaseKey)
		{
			...
			// remove these lines if you want CascadedEditorsSample migrations to run on your DB.
			...
			var migrationNamespace = "CascadedEditorsSample.Migrations." + databaseKey + "DB";
